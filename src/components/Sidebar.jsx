...
import { Shield, Activity, Terminal, ClipboardCheck } from 'lucide-react';
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-cyber-black border-r border-cyber-green/15 flex flex-col justify-between h-screen sticky top-0">
      <div>
        {/* Brand/Logo */}
        <div className="p-6 border-b border-cyber-green/15 flex items-center gap-3">
          <div className="w-8 h-8 rounded border border-cyber-green flex items-center justify-center bg-cyber-green/10 shadow-[0_0_8px_rgba(0,255,102,0.3)]">
            <Shield className="w-5 h-5 text-cyber-green" />
          </div>
          <div>
            <h1 className="font-extrabold text-sm tracking-widest text-white uppercase">AI Kavach</h1>
            <span className="text-[10px] text-cyber-green/70 tracking-wider">DEFENSE SHIELD</span>
          </div>
        </div>
